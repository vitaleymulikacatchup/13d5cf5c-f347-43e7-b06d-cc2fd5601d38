...
export const metadata: Metadata = {
  title: "Burger King | Flame Grilled Since 1954",
  description: "Discover flame-grilled perfection at Burger King. Quality burgers, crispy fries, and more. Order online or find your nearest location today.",
  keywords: "burger king, fast food, flame grilled burgers, whopper, fries, restaurant",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Burger King | Flame Grilled Since 1954",
    description: "Experience freshly flame-grilled burgers made with quality ingredients. Your Majesty awaits.",
    siteName: "Burger King",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763968535579-0wvze3qs.jpg",
        alt: "Fresh flame-grilled burger"
      }
    ]
  },
  twitter: {
    ...
    title: "Burger King | Flame Grilled Since 1954",
    description: "Experience freshly flame-grilled burgers made with quality ingredients.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763968535579-0wvze3qs.jpg"]
  }
};
